 ...
 */
export default function Card({ children, className = '', title, action, id }) {
  return (
    <div id={id} className={`bg-white rounded-2xl shadow-sm border border-green-100 overflow-hidden ${className}`}>
      {title && (
